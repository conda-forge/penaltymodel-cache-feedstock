...
Once the `conda-forge` channel has been enabled, `penaltymodel-cache` can be installed with:

```
conda install penaltymodel-cache
```

It is possible to list all of the versions of `penaltymodel-cache` available on your platform with:
